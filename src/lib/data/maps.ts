...
3.  **The Choice:** Larloch will not fight unless attacked. He offers a deal: Leave the Castle and he ends the curse on the valley, but keeps the souls he has already taken.`,
    nodes: [
        ...
        { id: "thay_embassy", x: 75, y: 70, label: "Abandoned Embassy", type: "encounter", description: "**ENCOUNTER:** 'The Red Ultimatum'. Zoltus (Red Wizard) has barricaded the **Fortified Embassy** (Bottom-Right). He demands the *Prism of the Void*. **OFFER:** Retrieve it, and he grants a *Thayan Writ of Passage*." },
