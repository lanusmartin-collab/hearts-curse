...
3.  **The Choice:** Larloch will not fight unless attacked. He offers a deal: Leave the Castle and he ends the curse on the valley, but keeps the souls he has already taken.`,
    nodes: [
        ...
        { id: "crows_nest", x: 60, y: 5, label: "The Crow's Nest", type: "info", description: "**LOOKOUT:** High vantage point overlooking the mists. **NPC:** 'Old One-Eye' (Kenku) watches for the dragon." },
